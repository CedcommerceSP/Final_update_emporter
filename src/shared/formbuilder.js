                                ...
                                return (
                                    <div className="col-12 mt-1 mb-1" key={this.state.form.indexOf(field)}>
                                        <TextField
                                            label={field.title}
                                            value={field.value}
                                            onChange={this.handleChange.bind(this, this.state.form.indexOf(field))}
                                        />
                                    </div>
                                );
                            case 'select':
                                        ...
                                        <div className="row">
                                            {
                                                field.options.map((option) => {
                                                    return (
                                                        <div className="col-md-4 col-sm-6 col-12" key={field.options.indexOf(option)}>
                                                            <Checkbox
                                                                checked={field.value.indexOf(option.value) !== -1}
                                                                label={option.label}
                                                                onChange={this.handleOptionsChange.bind(this, this.state.form.indexOf(field), field.options.indexOf(option))}
                                                            />
                                                        </div>
                                                    );
                                                })
