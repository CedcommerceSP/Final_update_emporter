...
export class Signup extends Component {
                    ...
                    <Card>
                        ...
                        <div className="col-12 mt-1 mb-1">
                            <TextField
                                ...
                                type="password"
                                error={this.fieldErrors.repeatPassword ? 'Passwords do not match' : ''}
                        ...
                        <div className="col-12 mt-1 mb-1">
                            <TextField
                                ...
                                type="number"
                                error={this.fieldErrors.phone ? 'Enter valid contact number' : ''}
                        ...
                        <div className="col-12 text-center mt-4 mb-5">
                            <Link className="mt-3" to="/auth/login">Already have an account?</Link>
                        </div>
                    </Card>
                </div>
            </div>
    ...
    register() {
        if (this.isFormValid()) {
            requests.getRequest('user/create', this.state)
                .then(data => {
                    if (data.success) {
