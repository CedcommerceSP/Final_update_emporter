...
class ResetPassword extends Component {
    ...
    isFormValid() {
        for (let i = 0; i < Object.keys(this.state).length; i++) {
            ...
            if (key!='reset_key' && !this.fieldValidations.password.test(this.state[key])) {
                return false;
            }
        }
        return true;
                    ...
                    <Card>
                        ...
                        <div className="col-12 mt-1 mb-1">
                            <TextField
                                label="New Password"
                                type="password"
                                error={this.fieldErrors.newpassword ? 'Enter valid Password' : ''}
                        ...
                        <div className="col-12 mt-1 mb-1">
                            <TextField
                                ...
                                type="password"
                                error={this.fieldErrors.confirmpassword ? 'Enter valid Password' : ''}
