                    ...
                    return (
                        <Card key={keys} title={`Step ${parseInt(keys) +1}:`} subdued={this.state.stepData[keys].optional}>
                            <div className="pb-5 pl-5 pr-5 pt-5 pt-sm-1">
                                <div className="row">
                                    <div className="col-sm-10 col-7 pt-sm-5"><h4>{this.state.stepData[keys].message} {this.state.stepData[keys].link}</h4></div>
                                    <div className="col-sm-2 col-3 pt-sm-3"><FontAwesomeIcon icon={faCheckCircle} size="5x" color="#0f0"/></div>
                                </div>
                            </div>
                        </Card>
                    );
