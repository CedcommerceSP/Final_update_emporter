...
import { Page, Card, Label, Modal, DisplayText,TextStyle } from '@shopify/polaris';
...
class Guide extends Component {
    ...
    renderOneTime = () => {
        return <Card>
            <div className="row p-5" style={{backgroundColor:"#5765c17a",height:'150px'}}>
            ...
            <div className="p-5">
                <Label id={"2"}>
                    <p className="mt-4">
                        Say, you got 910 products to Import
                    </p>
                </Label>
                <Label id={"3"}>
                    <ul className="mt-4">
                        <li>
                            10 products are free to check your listing.
                        </li>
                        <li>
                            Afterwards, pricing is 0.05 per product
                        </li>
                        <li>
                            So, one-time estimated charge will be :-
                        </li>
                    </ul>
                </Label>
                ...
                <div className="m-sm-5 p-sm-5 m-0 p-0">
                    <img
                        ...
                        onClick={() => {this.handleImageShow("https://apps.cedcommerce.com/importer/one_time.png")}}
                        alt={"image here"}
                        width={"100%"}/>
                    <Label id={"3"}>
                        <TextStyle variation="subdued">*Click on Image to Enlarge</TextStyle>
                    </Label>
                </div>
            </div>
        </Card>;
    ...
    renderSync = () => {
        return <Card>
            <div className="row p-5" style={{backgroundColor:"#5765c17a",minHeight:'150px'}}>
                <div className="col-12 col-sm-2 text-center text-sm-left">
                    <FontAwesomeIcon icon={faQuoteLeft} size="2x" color={"#4a4a4a"}/>
                </div>
                <div className="col-12 col-sm-8 text-center">
                    <span style={{fontSize:'15px', color: '#1a1a1a'}}>
                        <b>
                            I want Import products on Shopify + keep my inventory price synced with Marketplace
                        </b>
                    </span>
                </div>
                <div className="col-12 col-sm-2 text-center text-sm-right">
            ...
            <div className="p-5">
                ...
                <div className="mt-5">
                    <TextStyle>
                        To Sync Inventory and price of Uploaded products, you have to pay monthly charge for sync.
                    </TextStyle>
                </div>
                <div className="mt-5">
                ...
                <div className="m-sm-5 p-sm-5 m-0 p-0">
                    <img
                        ...
                        onClick={() => {this.handleImageShow("https://apps.cedcommerce.com/importer/sync.png")}}
                        alt={"image here"}
                        width={"100%"}/>
                    <Label id={"3"}>
                        <TextStyle variation="subdued">*Click on Image to Enlarge</TextStyle>
    ...
    render() {
        return (
            <Page title={"Guide"} primaryAction={{content:"back",onClick:()=>{this.redirect('/panel/plans')}}}>
                {/*<Card>*/}
                    <div className="mt-5 guide-plan">
                        {this.renderOneTime()}
                    </div>
                ...
                <Modal open={this.state.open} onClose={() => {
                    this.setState({open: false});}} title={"Image"} large>
                    <Modal.Section>
