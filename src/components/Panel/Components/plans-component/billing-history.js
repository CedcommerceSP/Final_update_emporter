            ...
            <Page
                ...
                <Card title="Billing History">
                    <div className="p-5">
                        ...
                        <img className="w-100" style={{height: 300}}
                             src="https://cdn.shopify.com/s/files/1/0757/9955/files/empty-state.svg"/>:null
                    }
                        <div className={"mt-5"}>
                            {this.state.data_secondary.length!=0?
                                <Button className="pl-0" primary={true} onClick={this.handleToggleClick}>
