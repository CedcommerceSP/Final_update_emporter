        ...
        this.state = {
            ...
            faq: [
                ...
                },
                {
                    ...
                    ans: <div>
                        You can connect your Amazon account to the Shopify store by following these steps:
                        <ul>
                            <li> Go to the ‘Accounts’ section.</li>
                            <li> Click on the ‘Connect’ button in the Amazon section and enter the correct credentials to connect to the app. </li>
                        </ul>
                ...
                },
                {
                    ...
                    ans: <div> Steps to upload the products from  app to my Shopify store:
                        <ul>
                ...
                },
                {
                    ...
                    ans: <div> You can upload selected products by creating a profile with selected attributes such as quantity, title or price.
                        Steps of Profiling:
                        <ul>
                            <li> Go to Profiling section.</li>
                            <li> Select filters according to your need and apply it your products and then upload them on Shopify from Import/upload and then select the custom profile rather than default profiling.</li>
                        </ul>
                    </div>
                },
                {
                    ...
                    ans: <div>To import products go to - ‘Import/Upload’ section
                        <ol> <li> Import Products: It helps to get the products from selected source marketplace (from where you want to import products) to the app.</li>
                            <li> Upload Products: It helps to make products uploaded from app to Shopify.</li>
                        </ol>
                        <ol> <li> To make products visible on Shopify you have 3 option to uploaded it:</li>
                            <li> Bulk Upload: It can be done from Upload Products in ‘Import/Upload’ section</li>
                            <li> Upload Specific product: Can upload selected products by creating Profile,
                                <br/><br/>
                                Kindly Refer Ques <br/>
                                <i style={{cursor:'pointer'}} onClick={this.handleToggleClick.bind(this, {id: 17})}>
                                    <b>What is profiling?</b>
                                </i>
                                <br/>
                                to know more about profiling.<br/><br/></li>
                            <li> Select and upload: Go to the ‘Products’, select the products which need to be uploaded then upload it by clicking on the Upload Button.</li>
                        </ol>
                    </div>
                },
                {
                    ...
                    ans: <div>To reconnect your account, steps given below:
                        <ol>
                            <li> Go to the Accounts section.</li>
                            <li> Go to Amazon marketplace and click on reconnect option.</li>
                            <li> Enter the correct credentials, click on Submit Button, your account will be automatically connected to your Amazon marketplace. </li>
                        </ol>
                        For further assistance, you can see the <a href="http://apps.cedcommerce.com/importer/amazon_UK_IN.pdf"> HELP PDF </a>  option.
                    </div>
                },
                {
                    id:13,
                    ...
                    ans: <div>This error means wrong credentials entered, to fix this, you should try reconnect your eBay account.
                            To reconnect your account, follow the steps given below:
                            <ol> <li> Go to accounts.</li>
                                <li> Click reconnect.</li>
                                <li> select the country.</li>
                                <li> enter your details (like Seller Id, Token, etc) and click the “submit” button. </li>
                            </ol>
                        </div>
                },

                {
                    ...
                    ans: <div> This error may be caused due to any of the following cases
                        <b> CASE 1: </b> The details of the Walmart seller panel that you have provided may be wrong. So kindly re-connect your Walmart account by following the steps:
                        <ol> <li> Go to the Accounts section.</li>
                            <li> Go to Walmart marketplace and click on reconnect option.</li>
                            <li> Enter the correct credentials, click on Submit Button, your account will be automatically connected to your Walmart marketplace. </li> </ol>
                        For further assistance, you can see the <a href="http://apps.cedcommerce.com/importer/walmart_doc.pdf"> HELP PDF </a> option.
                        <b> CASE 2:</b> Please try again later, it may be happens because we didn’t get proper response from Walmart.
                    </div>
                },
                {
                    id:15,
                    ...
                    ans: <div>To make products visible on Shopify you have to upload it- from App.
                         <br/><br/>
                        Kindly Refer Ques <br/>
                        <i style={{cursor:'pointer'}} onClick={this.handleToggleClick.bind(this, {id: 11})}>
                ...
                },
                {
                    ...
                    ans: <div> No, when product imported from selected marketplace, it will only get imported on app only, to upload it on Shopify you have to upload.
                        <br/><br/>
                        Refer Ques <br/>
                        <i style={{cursor:'pointer'}} onClick={this.handleToggleClick.bind(this, {id: 11})}>
                            <b>Stuck on product import/upload process?</b>
                        ...
                        to know more.
                        <br/><br/>
                        <b> Note: </b> <i> First 10 products are uploaded for free and after that, you need to pay $0.05/product for uploading on Shopify </i>
                    </div>
                },
                {
                    id:17,
                    ...
                    ans: <div>
                        You can upload by creating profile with different attributes (such as quantity, title or price). While uploading select the profile you created and then click upload products.
                    </div>
                },
                {
                    id:18,
                    ...
                    ans: <div>Ans. 12. Yes, you can upload selected products on shopify by following the steps given below:
                        <ol> <li> Go to Products</li>
                            <li> Select the products you want to upload( you can apply various filters such as- SKU, title, price and quantity). </li>
                            <li> From <b> ACTIONS </b> select <b> upload </b> and then products will be uploaded on Shopify. </li> </ol>
                    </div>
                },
                {
                    id:19,
                    ...
                    ans: <div> Ans.13. To create a profile, follow the steps:
                        <ol> <li> Go to PROFILING Section</li>
                            <li> Click on CREATE PROFILE </li>
                            <li> Enter a profile name and select the source. </li>
                            <li> Now, click - “save and move to next step”. </li>
                            <li> Select the attributes, enter the filter value and click CREATE PROFILE.</li> </ol>
                    </div>
                },
                {
                    id:20,
                    ...
                    ans: <div>Ans.14. Yes, to enable or disable inventory sync you can go to CONFIGURATION,
                        <ol>
                            <li> then to Shopify configuration, </li>
                            <li> now to Product Sync. </li>
                            <li> Here you can enable/disable it and select the fields which you want to sync with Shopify.</li>
                        </ol>
                    </div>
                },
            ]
